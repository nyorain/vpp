...
public:
	...
	void initInstance(vk::DebugReportFlagsEXT, Range<const char*> ext, Range<const char*> layers,
		bool reverseLayers);
	void initDevice(vk::PhysicalDevice, Range<const char*> ext, Range<const char*> layers,
		bool reverseLayers);
	void initDevice(Range<const char*> ext, Range<const char*> layers, bool reverseLayers);
	...
	vk::PhysicalDevice choosePhysicalDevice(Range<vk::PhysicalDevice> devices) const;
